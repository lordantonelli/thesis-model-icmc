...
\begin{algorithmic}[1]
\Procedure{Euclid}{$a,b$}\Comment{O maior divisor comum de \textit{a} e \textit{b}The g.c.d. of a and b}
\State $r\gets a\bmod b$
\While{$r\not=0$}\Comment{Tem-se a resposta seWe have the answer if \textit{r}r éis 0}
\State $a\gets b$
\State $b\gets r$
\State $r\gets a\bmod b$
\EndWhile\label{euclidendwhile}
\State \Return\textbf{return} $b$\Comment{O maior divisor comum éThe gcd is \textit{b}b}
\EndProcedure
\end{algorithmic}
\end{algoritmo}
